...
function carouselCalculateOffset() {
	...
	carouselItems.style.paddingLeft = `${carouselCalculateOffset - 16}px`;
	carouselItems.style.paddingRoght = `${carouselCalculateOffset - 16}px`;
}

function slide(wrapper, items) {
	let posX1 = 0,
		posX2 = 0,
		posInitial, posFinal, threshold = 100,
		itemToShow = 4,
